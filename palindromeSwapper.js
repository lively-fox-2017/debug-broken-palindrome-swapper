 ...
 */
function palindromeSwapper(str) { // method palindromeSwapper menerima sebuah parameter berupa string
  if(isPalindrome(str) === true){
    return true
  }
  let newStr = ''; // variable penampung
...
console.log(palindromeSwapper('raeccar')); // FALSE
